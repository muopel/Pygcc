...
def Henry_duan_sun(TK, P, I):
    ...
    # Honoring limits for Duan and Sun - P-T-X range (0â€“ 2000 bar, 0â€“260Â°C, 0â€“4.3 m NaCl)
...
def Helgeson_activity(TC, P, I, Dielec_method = None, **rhoEDB):
    ...
    ----------
       ...
       rhoEDB   :   dictionary of water properties like density (rho), dielectric factor (E) and
                       Debyeâ€“HÃ¼ckel coefficients (optional)
    Returns:
    ----------
       aw       :   solvent activity
...
class calcRxnlogK():
    ...
    ----------
        ...
        Al_Si : string
            specify either 'pygcc' or 'ArnÃ³rsson_StefÃ¡nsson' as the input to express Al and Si species in solid solution (optional), 'ArnÃ³rsson_StefÃ¡nsson' expresses them as 'Al(OH)4-' and 'H4SiO4(aq)', respectively while pygcc uses 'Al3+' and 'SiO2(aq)', respectively if not specified default - 'pygcc'
        sourceformat : string
    ...
    ----------
        ...
        (2) For water dielectric properties at any Temperature and density :  \n
            ...
            where T is temperature in celsius and rho is density in kg/mÂ³
    ...
    def AllRxnslogK( self, TC, P, rhoEG):
        ...
        -------
            ...
            The calculated dictionary of reaction thermodynamic properties has the following properties:
                ...
                * source: Source of thermo data, [kJ/kgÂ·K]
...
def outputfmt(fid, logK, Rxn, *T, dataset = None, logK_form = None):
    ...
    ----------
        ...
        logK_form : string
            specify the format of logK either as a set of eight values one for each of the datasetâ€™s principal temperatures, or blocks of polynomial coefficients,  [values, polycoeffs], default is 'a set of eight values' (optional)
...
class write_database():
    ...
    ----------
        ...
        logK_form : float, vector
            specify the format of logK either as a set of eight values one for each of the datasetâ€™s principal temperatures, or blocks of polynomial coefficients, [values, polycoeffs] default is 'a set of eight values'   \n
        densityextrap : float, vector
    ...
    ##extract that
        ...
        for j in specielist[1]:
            if j not in missing_species:
                if sourceformat.upper() == 'GWB': #looking at GWB as a source, only writing pflotran
